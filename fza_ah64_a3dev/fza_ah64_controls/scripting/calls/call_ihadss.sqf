...
if (vehicle player != _heli && !(vehicle player isKindOf "fza_ah64base") || !(alive _heli) && !(vehicle player isKindOf "fza_ah64base") || !(alive player)) then {1 cuttext ["", "PLAIN"]; 2 cuttext ["", "PLAIN"]; fza_ah64_bweff ppEffectEnable false; fza_ah64_fgeff ppEffectEnable false;};if(!(isNil "fza_ah64_notargeting")) exitwith {};
_heli = _this select 0;
